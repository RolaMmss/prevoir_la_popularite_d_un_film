...
CUSTOM_SETTINGS = {
    ...
    'CSV_FIELDS_TO_EXPORT': ['titre','fin_semaine_1', 'boxoffice_1', 'boxoffice_2', 'film_id_allocine' ],  
    'ITEM_PIPELINES': {
...
class BoxofficeSpider(CrawlSpider):
    ...
    base_url = 'https://www.allocine.fr/boxoffice/france/'
    num_pages = 8000
    ...
    def parse_film(self, response):
        ...
        yield scrapy.Request(box_office_url, callback=self.parse_box_office, meta={'titre': titre, 'film_id_allocine': film_id})
    ...
    def parse_box_office(self, response):
        ...
        allocine_movies_items['film_id_allocine'] = response.meta['film_id_allocine']
